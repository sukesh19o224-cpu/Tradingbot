"""
🎯 STRATEGY 2 - 50/50 BALANCED STRICTER
Higher Quality Than Strategy 1 - Moderately Stricter Rules
"""
...
DISCORD_WEBHOOK_URL = ''  # No Discord for Strategy 2
DISCORD_ENABLED = False  # Dashboard monitoring only
DISCORD_MENTION_ON_HIGH_SCORE = False
...
print(f"📊 Strategy: 50% Swing (score ≥8.3, ADX ≥32) + 50% Positional (score ≥7.5, ADX ≥27)")
...
print(f"📱 Discord: ❌ DISABLED • Dashboard: ✅ Port {DASHBOARD_PORT}")
