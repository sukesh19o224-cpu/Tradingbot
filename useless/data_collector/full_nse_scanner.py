...
class FullNSEScanner:
    ...
    def scan_stock(self, symbol):
        ...
        try:
            ...
            if score > 30:
                # Use MOMENTUM strategy config for full NSE scanner
